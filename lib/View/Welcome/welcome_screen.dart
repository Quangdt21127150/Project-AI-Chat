...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center( // Để căn giữa nội dung theo chiều ngang
        child: Container(
          padding: EdgeInsets.all(tDefaultSize),
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Image(image: AssetImage(welcomeScreenImage), height: height * 0.5),
              Column(
                children: [
                  Text(welcomeString, style: Theme.of(context).textTheme.headlineSmall),
                  Text(
